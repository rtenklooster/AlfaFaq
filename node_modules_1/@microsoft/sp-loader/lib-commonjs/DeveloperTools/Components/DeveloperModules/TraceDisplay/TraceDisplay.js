...
var TraceDisplay_module_scss_1 = tslib_1.__importDefault(require("./TraceDisplay.module.scss"));
var TraceDisplayStore_1 = tslib_1.__importDefault(require("./../../../Stores/TraceDisplayStore"));
var TraceList_1 = tslib_1.__importDefault(require("./TraceList/TraceList"));
var TraceDisplay = /** @class */ (function (_super) {
    tslib_1.__extends(TraceDisplay, _super);
