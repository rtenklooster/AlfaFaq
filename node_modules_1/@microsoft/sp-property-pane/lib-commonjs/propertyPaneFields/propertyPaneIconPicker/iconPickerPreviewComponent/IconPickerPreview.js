...
var IconPickerPreview = /** @class */ (function (_super) {
    ...
    function IconPickerPreview() {
        ...
        _this.setInstanceRef = function (instance) {
    ...
    IconPickerPreview.prototype.render = function () {
        return (React.createElement("div", { className: IconPickerPreview_module_scss_1.default.root },
            ...
            (0, ThumbnailPickerUtils_1.getThumbnailPickerButtons)(this._handleClick, this.props.onItemDeleted, IconPickerPreview_module_scss_1.default.changeButton, 'iconPicker'),
            React.createElement(IconPicker_1.IconPicker, { ref: this.setInstanceRef, onSelect: this.props.onItemChanged, customIconSet: this.props.customIconSet })));
    };
