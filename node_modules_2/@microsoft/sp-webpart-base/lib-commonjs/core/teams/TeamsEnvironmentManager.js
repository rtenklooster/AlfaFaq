...
var TeamsEnvironmentManager = /** @class */ (function () {
    ...
    TeamsEnvironmentManager.initialize = function () {
        ...
        var teamsPromise;
        if ((0, Flights_1.isTeamsV2Enabled)()) {
            teamsPromise = Promise.resolve().then(function () { return __importStar(require(/* webpackChunkName: 'spfx-core-teamsenv-teamsJs-v2' */ '@microsoft/teams-js-v2')); });
        }
        else {
            teamsPromise = Promise.resolve().then(function () { return __importStar(require(
